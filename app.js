...
// API
// =============================================
const API_SEARCH   = q   => `https://ryuu-dev.offc.my.id/discovery/search/youtube?q=${encodeURIComponent(q)}`;
const API_DOWNLOAD = url => `https://ryuu-dev.offc.my.id/downloader/youtube?url=${encodeURIComponent(url)}&format=mp3`;
